...
/* Simple Insert into the  table with the size, type level that the name is being inserted into */
...

{
  struct SymbTab * n;
   ...
   /* Check on how many elements we have in the table */
      if(first==NULL)
      {
        first=p;
      }
